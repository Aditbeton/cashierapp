...
<aside class="main-sidebar sidebar-light-red elevation-4">
    <a href="/" class="brand-link">
        <img src="<?php echo e(asset('images/lojo.jpg')); ?>" alt="Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
...
$shop = substr($appName, 5); // "Shop"
  ...
  text-shadow:
        -1px -1px 0 black,
         1px -1px 0 black,
        -1px  1px 0 black,
         1px  1px 0 black;"><?php echo e($lapet); ?></span>
  ...
  text-shadow:
        -1px -1px 0 black,
         1px -1px 0 black,
        -1px  1px 0 black,
         1px  1px 0 black;  "><?php echo e($shop); ?></span>
        </span>
    </a>
...
<?php /**PATH C:\laragon\www\mugon-tokas\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>