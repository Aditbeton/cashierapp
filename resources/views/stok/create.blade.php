...
@section('content')
    <div class="row">
        <div class="col-xl-4 col-lg-6">
            <form method="POST" action="{{ route('stok.store') }}" class="card card-red card-outline">
        ...
        function fetchProduk(search) {
            ...
            `);
                ...
                result.forEach((produk, index) => {
                    ...
                    row +=
                        `<button type="button" class="btn btn-xs btn-success" onclick="addProduk(${produk.id}, '${produk.nama_produk}')">`;
                    row += `Add</button>`;
                    row += `</td>`;
                    row += `</tr>`;
