...
@section('content')
    <div class="row">
        <div class="col-xl-4 col-lg-6">
            <form method="POST" action="{{ route('produk.store') }}" class="card card-red card-outline">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <x-select name="kategori_id" :options="$kategoris" /> {{-- FIX --}}
                    </div>
                    <div class="form-group">
                        <label>Diskon</label>
                ...
                <div class="card-footer form-inline">
                    ...
                    <a href="{{ route('produk.index') }}" class="btn btn-secondary ml-auto"> {{-- FIX --}}
                        Batal
                    </a>
                </div>
            </form>
